...
if __name__ == '__main__':
    ...
    dataset_folder = f"/home/cameron/PycharmProjects/auto_coding/dataset/source_code/"
    file_path = dataset_folder + "json/train.jsonl"
    ...
    path = os.path.join(dataset_folder, "cache")
    print(path)

    try:
        os.remove(path + "/inputs.pk")
    except:
        print('no cache found')

    train_dataset = SrcCodeDataset(file_path, model, cache_path=path)
