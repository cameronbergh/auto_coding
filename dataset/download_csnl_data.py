...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir', type=str, default='./csnl_data/',
    ...
    call(['wget', 'https://git.kernel.org/torvalds/t/linux-5.9-rc2.tar.gz', '-P', destination_dir])
    call(['tar', '-xf', 'linux-5.9-rc2.tar.gz'])
